...
export default function Home() {
  ...
  const handleSidebarMinimized = () => {
    ...
    let sidebarContainerClasses = ['w-80']
        ...
        <div className="flex flex-col items-center w-full">
          <div className="w-full h-1/3">
            <nav className="flex items-center w-full h-16 bg-white border-b border-purple-800 shadow-lg shadow-2xl dark:bg-black">
              <img src="http://people.ixtelecom.net/img/logos/hrms-new.png" className="w-10 h-10 my-auto ml-5" alt=""/>

              <div className="inline-flex ml-auto mr-5 -mx-2">
                <span className="mx-2 my-auto">
          ...
          <div className="w-full">
            ...
            <main className="w-full h-screen bg-gray-200 dark:bg-dark-gray-100 ">

              <div className="w-full h-64 bg-white dark:bg-black">
              ...
              <div className="mx-10 -mt-20">
                ...
                <div className="w-full h-auto border border-purple-800 rounded shadow-2xl dark:bg-gray-300 bg-dark-gray-50">
                  ...
                  <div className="p-5 pb-10">
                    ...
                    <div className="mt-5 -mx-4 grid grid-cols-4 gap-y-7">
              ...
              <div className="mx-10 mt-10">
                <div className="border border-purple-800 rounded shadow-2xl bg-dark-gray-50 dark:bg-gray-300">
                  ...
                  <div className="flex items-center justify-between px-5 pt-5">
                    ...
                    <input type="text" placeholder="Search Leave..." className="w-64 h-12 px-3 py-2 text-xs font-light placeholder-black bg-white border-2 rounded appearance-none focus:border-blue-200 transition-all duration-200"/>
                  </div>
